...
<body class="admin-page">
    ...
    <div class="admin-container">
        ...
        <div class="admin-grid">
            ...
            <form action="update_property.php" method="POST" class="grid-item">
            ...
            <!-- Description Card -->
            <form action="update_description.php" method="POST" class="grid-item">
                <input type="hidden" name="property_id" value="<?php echo $property['id']; ?>">
                ...
                <div class="admin-card-body">
                    ...
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                        ...
                        <?php if($canUpload): ?>
                            ...
                            <form id="upload-form" action="upload_images.php" method="POST" enctype="multipart/form-data" style="display: none;">
                                <input type="hidden" name="property_id" value="<?php echo $property['id']; ?>">
                                <input type="file" id="image-upload-input" name="images[]" multiple accept="image/jpeg,image/jpg,image/png" onchange="this.form.submit()">
                            </form>
                        <?php endif; ?>
                    </div>
                    <?php if($imageCount > 0): ?>
